...
public class IndexServiceImpl implements IndexService {
    ...
    public Map<String, Object> getUserInfo(String userId) {
        ...
        System.out.println("用户的权限"+permissionValueList);
     ...
     * @return
     */
    public List<JSONObject> getMenu(String userId) {
        //根据用户id获取用户菜单权限
        List<JSONObject> permissionList = permissionService.selectPermissionByUserId(userId);
