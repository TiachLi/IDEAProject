...
<div class="app-container">
    ...
    <el-steps :active="4" process-status="wait" align-center style="margin-bottom: 40px;">
  ...
  <div style="margin-top: 20px">
      ...
      <el-form :rules="seatValidateRules" :inline="true" class="demo-form-inline">
          ...
          <router-link :to="'/cinemaHal/seat/disable?hn='+this.hallName">
            <el-button type="primary"  v-if="hasPerm('seat.addTotal')">返回修改</el-button>
          </router-link>
          </el-form-item>
          <router-link :to="'/cinemaHal/hall/list'">
